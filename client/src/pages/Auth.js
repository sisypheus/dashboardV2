...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    // createUserWithEmailAndPassword(auth, 'fake@gmail.com', 'testtest').then((res) => {
    //   console.log(res);
    // }).catch((err) => {
    //   console.log(err);
    // });
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <button type="button" className="items-center justify-center w-full p-2 font-semibold text-gray-900 bg-white border-2 border-gray-500 rounded-md shadow outline-none hover:bg-yellow-50 hover:border-yellow-400 focus:outline-none">
