...
Then you'll need to start the server:__
`npm start`__
It will launch the process on the port 8080.__

Then you'll need to start the client:__
`npm start`__
It will launch the process on the port 3000.__
